...
# All AWS resources removed 2026-08-19 (teardown): 2 EC2 instances, security
# group, key pair, and the orbit_storage S3 bucket. The aws provider stays
# declared so the destroy plan can run; the subnet_id variable stays declared
# because the Spacelift stack dependency may still inject TF_VAR_subnet_id.
