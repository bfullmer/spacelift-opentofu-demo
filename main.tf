...
# Lab teardown (2026-08-19, second cycle): removed the WordPress web fleet,
# DB instance, security groups, and key pair. Only the harmless non-AWS demo
# scaffold above remains. Rebuild recipe: ~/.claude/skills/orbit-labs and
# the orbit-labs-aws-lab wiki page.
