...
# Lab teardown (2026-08-19): removed the web fleet, DB instance, security
# groups, and key pair. This leaves only the original harmless demo
# scaffold (random/local resources, AWS identity check) - no billable AWS
# infrastructure. Same pattern as the first teardown earlier today.
